...
If the gate fails, the system must not fit product temperatures. It records the completed evidence and diagnoses implementation, draw coupling, or non-monotonic empirical behavior under a separate reviewed protocol.
