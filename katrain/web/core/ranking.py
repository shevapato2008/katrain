...
def calculate_rank_update(
    current_rank: str, current_net_wins: int, current_elo: int, won: bool
    ...
    # Boundary checks
    if new_rank_val < -19.0:
        new_rank_val = -19.0
    if new_rank_val > 12.0:
        new_rank_val = 12.0  # Max 12d?
