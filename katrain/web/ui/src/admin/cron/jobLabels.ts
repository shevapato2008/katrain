export const jobLabels: Record<string, string> = {
  poll_moves: '直播 - 落子轮询', analyze: '直播 - 分析', report_analyze: '复盘 - 分析',
  fetch_upcoming: '直播 - 赛事预告', fetch_list: '直播 - 赛事列表', poll_pandanet: '直播 - Pandanet 对局',
  translate: '直播 - 棋手译名', tutorial_backup: '教程 - 备份', cleanup: '系统 - 数据清理',
};
