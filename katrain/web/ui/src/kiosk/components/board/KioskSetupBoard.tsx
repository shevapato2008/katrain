 ...
 * 不让子那一局的起始局面就是**空盘**,所以那一态下一颗子都不摆 —— 空不是占位,是答案;
 * 让子局的起始局面带着那几颗黑子,`handicap` 那段说的就是这件事。
 *
...
interface KioskSetupBoardProps {
   ...
   *
   * **本地对局那一屏不传**(2026-08-23 屏 04):两个人面对面,谁执黑不是这块屏上的一次
   * 选择,而是两个人自己坐好的。硬塞一个 `'black'` 会让 `data-color` 说出一个屏上
   * 根本没发生过的选择 —— 不传就整个属性不出。
   */
  color?: 'black' | 'white';
