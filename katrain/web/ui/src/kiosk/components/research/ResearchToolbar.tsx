      ...
      <Box
        ...
        sx={{
          ...
          bgcolor: active && !disabled
            ? (isDestructive ? alpha(theme.palette.error.main, 0.16) : 'primary.dark')
            : 'background.paper',
          ...
          borderColor: active && !disabled
            ? (isDestructive ? alpha(theme.palette.error.main, 0.4) : 'primary.main')
            : 'divider',
          ...
          '&:hover': {
            bgcolor: disabled
              ? 'background.paper'
              : (active
                ? (isDestructive ? alpha(theme.palette.error.main, 0.25) : alpha(theme.palette.primary.main, 0.3))
                : 'action.hover'),
          },
        }}
      >
