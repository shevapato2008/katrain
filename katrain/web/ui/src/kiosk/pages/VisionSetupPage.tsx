...
const VisionSetupPage = () => {
  ...
  return (
    <Box sx={{ width: '100%', height: '100%', minHeight: 0, display: 'flex', flexDirection: 'column', gap: 1.5, p: 2 }}>
      <Box>
        <Button variant="text" startIcon={<ArrowBack />} onClick={() => navigate(-1)}>返回</Button>
      </Box>
