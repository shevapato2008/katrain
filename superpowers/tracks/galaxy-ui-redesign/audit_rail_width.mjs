...
const TIERS = [
  ...
  /* 2026-09-01：顶档不再只看宽度。宽扁屏（≥16:9）给 620，高屏留 520 ——
     棋盘是正方形、在宽屏上由**高度**封顶，所以死白边由宽高比决定而不是宽度。
     实测：1920x1080 天花板 652、1920x1200 只有 532、1920x1440 是 520（一寸都不能加）。
     这两行分别钉两条分支，缺一条就有一支永远没人走。 */
  [1920, 1080, 620], [2560, 1440, 620], [2000, 1050, 620],
